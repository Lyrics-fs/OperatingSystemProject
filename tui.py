...
class TerminalUI:
    ...
    def _main_loop(self, stdscr):
        ...
        curses.init_pair(1, curses.COLOR_GREEN, curses.COLOR_BLUE)  # 目录颜色
        curses.init_pair(2, curses.COLOR_GREEN, curses.COLOR_BLUE)  # 大小颜色
        curses.init_pair(3, curses.COLOR_GREEN, curses.COLOR_BLUE)  # 选中行颜色
